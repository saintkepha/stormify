...
(function() {
  ...
  DataStoreModel = (function(_super) {
    ...
    function DataStoreModel(data, opts) {
      var key, name, prop, val, violations, _ref, _ref1, _ref2, _ref3, _ref4;
      this.properties = {
        createdOn: {
          value: null
        },
      ...
      for (name in _ref2) {
        ...
        if (!prop.value) {
          ...
          if ((prop.type != null) && prop.type !== 'date' && prop.type !== 'uuid' && prop.type !== 'email' && prop.type !== 'toggle') {
            if ((prop.type != null) && typeof prop.value !== prop.type) {
              violations.push("'" + name + "' must be a " + prop.type + " and not " + (typeof prop.value));
            }
          }
    ...
    DataStoreModel.prototype.get = function(property, callback) {
      ...
      enforce = function(x) {
        ...
        if ((prop != null ? prop.opts : void 0) == null) {
          return x;
        }
        violations = [];
        ...
        val = (function() {
          ...
          switch (false) {
            ...
            case !((prop.model != null) && x instanceof Object):
              try {
                inverse = (_ref1 = prop.opts) != null ? _ref1.inverse : void 0;
                if (inverse != null) {
                  x[inverse] = this;
                }
      ...
      if (typeof (prop != null ? prop.computed : void 0) === 'function') {
        ...
        value = prop.value = enforce.call(this, prop != null ? prop.value : void 0);
        this.log.debug({
          method: 'get',
          property: property,
          id: this.id
  ...
  DataStore = (function() {
      ...
      if (entity["static"] != null) {
        ...
        _fn = (function(_this) {
          return function(entry) {
            ...
            return record != null ? record.save() : void 0;
          };
        })(this);
    ...
    DataStore.prototype.dump = function() {
      var entity, name, _ref, _results;
      _ref = this.entities;
      _results = [];
      for (name in _ref) {
        entity = _ref[name];
        _results.push(this.log.info({
          model: name,
