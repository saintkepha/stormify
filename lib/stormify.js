...
(function() {
  var DataStorm, Stormify, express, test,
  ...
  Stormify = (function(_super) {
    __extends(Stormify, _super);

    function Stormify() {
      return Stormify.__super__.constructor.apply(this, arguments);
    }

    Stormify.express = function(storm) {
      var router;
      this.assert(storm instanceof DataStorm.Model, 'cannot express without valid DataStorm passed-in');
      router = (require('express')).Router();
      router.all('*', authorizer(storm), function(req, res, next) {
        req.storm = storm;
        return next();
      });
      router.route("" + (storm.constructor.get('name'))).all(function(req, res, next) {
        return next();
  ...
  test = function() {
    var app, authorizer, bp, router, serializer;
    app = express();
  ...
  module.exports.passport = function(ds) {
    var AnonymousStrategy, BearerStrategy, authorizer, passport;
    passport = require('passport');
    BearerStrategy = require('passport-http-bearer');
    AnonymousStrategy = require('passport-anonymous');
    this.use(passport.initialize());
    passport.use(new AnonymousStrategy);
    return authorizer = function(store) {
