...
(function() {
      ...
      for (property in props) {
        ...
        if (typeof value.computed === 'function') {
          (function(property) {
            ...
            return self.log.info("completed task for computed property: " + property + "...");
          })(property);
        }
      }
      start = new Date();
  ...
  DataStoreController = (function(_super) {
    ...
    function DataStoreController(opts) {
      ...
      assert((opts != null) && opts.view instanceof DataStore, "unable to create an instance of DS.Controller without a proper view!");
  ...
  DataStore = (function(_super) {
    ...
    DataStore.prototype.findRecord = function(type, id) {
      ...
      record = (_ref1 = this.entities[type]) != null ? (_ref2 = _ref1.registry) != null ? _ref2.get(id) : void 0 : void 0;
      return record;
    };
  ...
  DataStoreView = (function(_super) {
    var extend;

    __extends(DataStoreView, _super);
