...
(function() {
  ...
  StormModel = (function(_super) {
    ...
    StormModel.prototype.invoke = function() {
      var action, args, func, prop, using;
      action = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      func = (function() {
        switch (false) {
          case !(action instanceof Function):
            return action;
          case (prop = this.getProperty(action)) == null:
            using = typeof prop.using === "function" ? prop.using() : void 0;
            return this[using];
          default:
            return null;
        }
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          var err;
          try {
            return resolve(func != null ? func.apply(_this, args) : void 0);
          } catch (_error) {
            err = _error;
            return reject(err);
          }
