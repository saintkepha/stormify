...
(function() {
  var BelongsToProperty, DataStormModel, DataStormObject, DataStormRegistry, HasManyProperty, ModelRegistry, ModelRegistryProperty, RelationshipProperty, assert,
  ...
  ModelRegistry = (function(_super) {
    ...
    ModelRegistry.prototype.register = function(model, opts) {
      return ModelRegistry.__super__.register.call(this, model.name, new ModelRegistryProperty(model, opts, this));
    };
    ...
    ModelRegistry.prototype.add = function() {
      ...
      for (_i = 0, _len = records.length; _i < _len; _i++) {
        record = records[_i];
        if (record instanceof DataStormModel) {
          obj[record.get('id')] = record;
        }
      }
      return ModelRegistry.__super__.add.call(this, record.constructor.name, obj);
    };
    ...
    ModelRegistry.prototype.remove = function() {
      ...
      return ModelRegistry.__super__.remove.call(this, record.constructor.name, query);
    };
  ...
  DataStormModel = (function(_super) {
    ...
    DataStormModel.Property = RelationshipProperty;

    DataStormModel.Registry = ModelRegistry;
    ...
    DataStormModel.prototype._models = new ModelRegistry;
    ...
    DataStormModel.prototype.fetch = function(id) {
      return this._models.find(this.constructor.name, id);
    };
