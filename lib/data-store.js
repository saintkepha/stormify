...
(function() {
  ...
  DataStoreModel = (function(_super) {
    ...
    function DataStoreModel(data, opts) {
      ...
      assert(Object.keys(this.properties).length > 0, "cannot construct a new data model without declared schema properties!");
    ...
    DataStoreModel.prototype.get = function() {
      ...
      enforce = function(x) {
        var record, val, validator, violations, _ref;
        if (!enforceCheck) {
          return x;
        }
        ...
        val = (function() {
          ...
          switch (false) {
            ...
            case !((prop.model != null) && prop.mode !== 3):
              ...
              break;
            case !(x instanceof Array && ((_ref4 = prop.opts) != null ? _ref4.unique : void 0) === true):
  ...
  DataStore = (function(_super) {
    ...
    DataStore.prototype.name = 'ds';

    DataStore.prototype.schema = null;
    ...
    function DataStore(data, opts) {
      var name, prop, _fn, _ref, _ref1;
      DataStore.__super__.constructor.call(this, data, opts);
      this.collections = {};
      this.entities = {};
      ...
      this.isReady = false;
      this.datadir = (_ref = opts != null ? opts.datadir : void 0) != null ? _ref : '/tmp';
      ...
      _fn = (function(_this) {
        return function(name, prop) {
          var _ref2;
          if (prop.registry == null) {
            prop.registry = new DataStoreRegistry(name, {
              log: _this.log,
              store: _this,
              persist: (_ref2 = prop.opts) != null ? _ref2.persist : void 0
            });
          }
          if (entity["static"] != null) {
            return entity.registry.once('ready', function() {
              var count, entry, _i, _len, _ref3;
              _this.log.info({
      ...
      for (name in _ref1) {
        prop = _ref1[name];
        if (!((prop.model != null) && prop.mode === 2)) {
          continue;
        }
        _fn(name, prop);
      }
