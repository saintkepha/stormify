...
(function() {
  var DataStormObject, DataStormRegistry, RegistryProperty,
  ...
  DataStormRegistry = (function(_super) {
    ...
    function DataStormRegistry() {
      return DataStormRegistry.__super__.constructor.apply(this, arguments);
    }

    DataStormRegistry.Property = RegistryProperty;

    DataStormRegistry.prototype.register = function(key, property) {
      return this.addProperty(key, property);
    };

    DataStormRegistry.prototype.keys = function() {
      return DataStormRegistry.__super__.keys.apply(this, arguments).filter((function(_this) {
        return function(key) {
    ...
    DataStormRegistry.prototype.find = function(key, query) {
      var _ref;
      return (_ref = this.getProperty(key)) != null ? _ref.match(query) : void 0;
    };

    DataStormRegistry.prototype.add = function(key, value) {
      var _ref;
      return (_ref = this.getProperty(key)) != null ? _ref.merge(value) : void 0;
    };

    DataStormRegistry.prototype.remove = function(key, query) {
      var _ref;
