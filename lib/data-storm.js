...
(function() {
  var DataStorm, EventEmitter, StormModel, StormObject, StormView, assert, bunyan,
    __slice = [].slice,
  ...
  StormView = (function() {
    ...
    function StormView(store, requestor) {
      var _ref;
      this.store = store;
    ...
    StormView.prototype.createRecord = function() {
      var args, record;
    ...
    StormView.prototype.deleteRecord = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.store.deleteRecord.apply(this, args);
    };

    StormView.prototype.updateRecord = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.store.updateRecord.apply(this, args);
    };

    StormView.prototype.findRecord = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.store.findRecord.apply(this, args);
    };

    StormView.prototype.findBy = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.store.findBy.apply(this, args);
    };

    StormView.prototype.find = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  ...
  DataStorm = (function(_super) {
    ...
    DataStorm.prototype.logfile = DataStorm.attr('string', {
      defaultValue: DataStorm.computed(function() {
        return "/tmp/" + this.constructor.name + "-" + (this.get('id')) + ".log";
      })
    });
