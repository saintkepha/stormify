...
(function() {
  ...
  getter = function(store, type) {
    return function() {
      ...
      if (!((condition != null) || __indexOf.call((_ref1 = this.req.authInfo) != null ? _ref1.scope : void 0, 'all') >= 0)) {
  ...
  putter = function(store, type) {
    return function() {
      ...
      try {
        assert(store instanceof DataStore && (type != null) && (store.entities[type] != null) && (this.body[type] != null), "invalid PUT request!");
      } catch (_error) {
        err = _error;
        return this.res.send(500, {
          error: err
      ...
      return store.updateRecord(type, this.params.id, this.body[type], (function(_this) {
