...
(function() {
  var StormClass, StormObject, YangClass, YangContainer, YangExtension, YangGrouping, YangList, YangListEntry, YangModule, YangObject, YangProperty, YangRemoteProcedure,
  ...
  YangClass = (function(_super) {
    __extends(YangClass, _super);

    function YangClass() {
      return YangClass.__super__.constructor.apply(this, arguments);
    }
    ...
    YangClass.define = function(keyword, args) {
