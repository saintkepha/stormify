...
class DataStorm extends DataStormModel
  ...
  addProperty: (key, prop) ->
    if prop instanceof DataStormModel.Property and prop.kind is 'hasMany' and prop.opts.private isnt true
  ...
  contains: (key) ->
    ...
    prop if prop instanceof DataStormModel.Registry.Property
