...
(function() {
  var DataStorm, DataStormModel, DataStormObject, DataStormView, EventEmitter, SR, assert, bunyan,
    __slice = [].slice,
  ...
  DataStorm = (function(_super) {
    ...
    DataStorm.Object = DataStormObject;
    ...
    DataStorm.prototype.addProperty = function(key, prop) {
      if (prop instanceof DataStormModel.Property && prop.kind === 'hasMany' && prop.opts["private"] !== true) {
    ...
    DataStorm.prototype.contains = function(key) {
      ...
      if (prop instanceof DataStormModel.Registry.Property) {
        return prop;
      }
    };
