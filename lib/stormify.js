...
(function() {
  var AnonymousStrategy, BearerStrategy, DataStore, assert, authorizer, createStore, passport;
  ...
  module.exports.express = function(storm) {
    var router, serializer;
    assert(storm instanceof DataStorm, 'cannot express without valid DataStorm passed-in');
    ...
    router.route("" + storm.name).all(function(req, res, next) {
      return next();
    ...
    router.route("" + storm.name + "/:collection").all(function(req, res, next) {
      return next();
    }).get(function(req, res, next) {
