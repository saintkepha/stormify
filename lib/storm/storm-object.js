...
(function() {
  ...
  StormObject = (function(_super) {
    ...
    function StormObject(data, opts, container) {
      var StormForm, input, key, _ref;
      this.opts = opts != null ? opts : {};
      this.container = container;
      this._properties = {};
      for (key in this) {
        StormForm = this[key];
        if (!(key !== 'constructor' && ((StormForm != null ? (_ref = StormForm.meta) != null ? _ref.storm : void 0 : void 0) != null))) {
          continue;
        }
        input = (function() {
