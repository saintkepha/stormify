...
(function() {
  ...
  module.exports.serve = function(store, opts) {
    var action, baseUrl, collection, entity, name, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _results;
    if (this.del == null) {
    ...
    for (collection in _ref1) {
      ...
      if (!(entity.isReadOnly || entity.persist === false)) {
        ...
        for (action in (_ref4 = entity.controller) != null ? _ref4.prototype.actions : void 0) {
          ...
          this.post("" + baseUrl + "/" + collection + "/:id/" + action, authorizer(store), getter(store, name), function() {
            var record;
            record = this.res.locals.matches[0];
            return this.send(record.invoke(action, this.req.query, this.req.body));
          });
        }
      }
      _results.push((_ref6 = store.log) != null ? _ref6.info({
        method: "serve"
